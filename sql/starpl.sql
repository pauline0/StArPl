...
ALTER TABLE `releaseRequests` ADD CONSTRAINT fk_student_acc_id FOREIGN KEY (`studentAccountId`) REFERENCES `studentAccounts`(`Id`) ON DELETE CASCADE;
--ALTER TABLE `releaseRequests` ADD CONSTRAINT fk_files_id FOREIGN KEY (`fileId`) REFERENCES `files`(`Id`) ON DELETE CASCADE;
